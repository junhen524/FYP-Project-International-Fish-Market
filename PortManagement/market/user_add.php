...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $email && $password) {
        try {
            ...
            dbExecute("INSERT INTO market_user (username, email, password_hash, full_name, phone) VALUES (?, ?, ?, ?, ?)",
  ...
  <div class="dash-content">
    ...
    <form method="post" style="max-width:820px;margin:0 auto;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        <div>
          <h2 style="margin:0;font-size:1.3rem;">➕ Add Market User</h2>
          <p class="subtle" style="margin:4px 0 0;">Create a new domestic user account</p>
        </div>
          ...
          <div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" id="username" name="username" class="form-input" required placeholder="e.g. johnny">
              </div>
              <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" class="form-input" required placeholder="e.g. john@example.com">
              </div>
              <div class="form-group">
