...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $email && $password) {
        try {
            ...
            dbExecute("INSERT INTO export_user (username, email, password_hash, full_name, company_name, business_type, country_code, identification_no, account_status, created_at) VALUES (?, ?, ?, ?, ?, 'restaurant', ?, ?, 'active', NOW())",
                [$username, $email, $hashed, $full_name, $company_name, $country_code, $identification_no]);
            $message = 'Restaurant created successfully.';
        } catch (Exception $e) { $error = 'Error: ' . $e->getMessage(); }
    } else { $error = 'Username, email and password are required.'; }
}
  ...
  <div class="dash-content">
    ...
    <form method="post" style="max-width:820px;margin:0 auto;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        <div>
          <h2 style="margin:0;font-size:1.3rem;">➕ Add Restaurant Partner</h2>
          <p class="subtle" style="margin:4px 0 0;">Create a new international restaurant account</p>
        </div>
        <a href="/dashboard/analytics/international/restaurants/" class="btn btn-ghost" style="padding:8px 16px;">← Back to Restaurants</a>
      </div>
      ...
      <div class="edit-card">
        ...
        <div class="edit-form">
          <div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" id="username" name="username" class="form-input" required placeholder="e.g. sakura_restaurant">
              </div>
              <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" class="form-input" required placeholder="e.g. contact@sakura.com">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="company_name" name="company_name" class="form-input" placeholder="e.g. Sakura Sdn Bhd">
              </div>
              <div class="form-group">
          ...
          <div class="action-buttons">
            <a href="/dashboard/analytics/international/restaurants/" class="btn-cancel">Cancel</a>
            <button type="submit" class="btn-save">➕ Add Restaurant</button>
          </div>
        </div>
      </div>
    </form>
