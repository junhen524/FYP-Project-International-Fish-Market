...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name) {
        try {
            dbExecute("INSERT INTO market_drivers (name, phone, port_id, license_no, vehicle_no, identification_no) VALUES (?, ?, ?, ?, ?, ?)",
                [$name, $phone, $port_id, $license_no, $vehicle_no, $identification_no]);
            $newId = dbLastInsertId();
            $message = 'Driver added successfully.';
            if ($newId) {
                redirect('/logistics/drivers/edit/?id=' . $newId);
                exit;
            }
  ...
  <div class="dash-content">
    ...
    <form method="post" style="max-width:820px;margin:0 auto;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        <div>
          <h2 style="margin:0;font-size:1.3rem;">➕ Add Driver</h2>
          ...
          <div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-input" required placeholder="e.g. Ahmad bin Ismail">
              </div>
              <div class="form-group">
                <label for="phone">Phone</label>
                <input type="text" id="phone" name="phone" class="form-input" placeholder="e.g. +60 12-345 6789">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="vehicle_no" name="vehicle_no" class="form-input" placeholder="e.g. ABC 1234">
              </div>
              <div class="form-group">
                <label for="license_no">License No</label>
                <input type="text" id="license_no" name="license_no" class="form-input" placeholder="e.g. DL-2024-5678">
              </div>
            </div>
          </div>
